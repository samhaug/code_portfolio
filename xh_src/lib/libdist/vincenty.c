...
int vincenty_inverse(double,double,double,double,double *,double *,double *);
...
int vincenty_direct(double phi1,double lambda1,double alpha12,double s, 
...
int vincenty_inverse(double phi_1,double L_1,double phi_2,double L_2,
    ...
    // given two coordinates, calculate distance and azimuth between them.
    ...
    *alpha2 = (180./M_PI)*atan2(cos_u1*sin_lambda,
               -1*sin_u1*cos_u2+cos_u1*sin_u2*cos_lambda);
    return(1);
}
