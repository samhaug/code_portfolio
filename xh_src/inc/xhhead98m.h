...
typedef struct {
	...
	struct  xhtime98  ot;		/* ref/origin time (sec)	*/
	struct  xhtime98  tstart;	/* seismogram start time (sec)	*/
    ...
    complx98 pole[NOCALPTS];	/* instrument poles	*/
    complx98 zero[NOCALPTS];	/* instrument zeroes	*/
    float   DS;
    float   A0;
