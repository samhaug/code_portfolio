...
int usage(){
    fprintf(stdout,"\n");
    fprintf(stdout,"ascii_rotate produces R/T records given N/E input and back-azimuth.\n");
    fprintf(stdout,"Records must be two-column whitespace delimited: time data. (Specfem output)\n");
    fprintf(stdout,"\n");
    fprintf(stdout,"USAGE: ascii_rotate baz N_in_file E_in_file R_out_file T_out_file\n");
    fprintf(stdout,"\n");
