...
printf("Usage : dc2mt Strike Dip Rake lat lon (in degrees) depth\n" );
printf("\n" );
printf("Output : CMTSOLUTION \n");
exit(1);
}
...
printf("AAAA %4d %3d %3d %3d %3d %9.5f %9.5f %9.5f %9.5f 0.0 6.0 MADE UP\n",1970,1,1,1,1,1.0,lat,lon,h);
printf("event name:     197001010100A\n");
printf("time shift:      0.0000\n");
printf("half duration:   1.0000\n");
printf("latitude:    %9.5f\n",lat);
printf("longitude:   %9.5f\n",lon);
printf("depth:       %9.5f\n",h);
printf("Mrr: %9.5fe+26\n",Mrr);
printf("Mtt: %9.5fe+26\n",Mtt);
printf("Mpp: %9.5fe+26\n",Mpp);
