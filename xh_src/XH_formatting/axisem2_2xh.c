//
// axisem2_2xh - Turns AxiSEM ascii from Tarje
...
char       *argv[];
{
    ...
    int       index = 0;
    int	      ierr;
    int       jdebug = 0; // debugging flag (=0 if turned off)
    int       i;
    int       i1, i2;
    xhhed     h;
    char      netwk[CHARSIZE];
...
int usage()
{
fprintf(stderr,"Usage: axisem2_2xh in_AXIsem out_XH -h EvDep -e eLat eLon -s sLat sLon -c NETW StNam CMP\n");
