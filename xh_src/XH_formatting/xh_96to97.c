...
#include <string.h>
#include <sys/param.h>
#include "/work/jeroen/inc/xhhead0.97.h"
#include "/work/jeroen/inc/xhhead0.96.h"	/* XH format structures */

/* Reads the XH 0.96 version and writes XH 0.97 version */
...
while (still_reading_data) {
  ...
  if ( fabsf(h_old.version-0.96) > 0.01) {
    fprintf(stderr,"FILE version of OLD Xh-file (=%f) is not 0.96 ... \n", h_old.version);
    exit(-1);
  }
...
char *flnm;
{
fprintf(stderr,"Usage: xh_96to97 in_XH out_XH\n");
return(-1);
}
